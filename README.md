...
**A Gaussian-splat segmentation playground, powered by [SpAItial AI](https://app.spaitial.ai) worlds**

**G**enerate a 3D world on [SpAItial AI](https://app.spaitial.ai), view its Gaussian splat in the browser, segment objects in it on demand with [SAM3](https://huggingface.co/facebook/sam3), lift the 2D masks into the 3D Gaussians, then recolor / isolate those Gaussians — "segment once, reuse again".
